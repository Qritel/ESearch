...
my_url = 'http://emploi-public.ma/fr/candidaturesListe.asp?c=0&e=1'

filename = "Postes_de_responsabilité/Etablissements et Entreprises publics.csv"
f = open(filename, "w")
headers = " Id,\
...
for i in range(1, int(last_page) + 1):
    ...
    for row in table.findAll('tr'):
        ...
        s = cells[0].a["href"]
        f.write("poste_e1id" + re.findall("(?<=id=)(\d+)", s)[0] + ",")
        for j in range(3):
